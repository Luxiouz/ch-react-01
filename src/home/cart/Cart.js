    ...
    return (
        <div>
            ...
            <div className="text-end">
                {authUser?<NavLink to="/checkout" className="ms-2 my-4 btn btn-success btn-add-cart">Ir a Checkout</NavLink>:
                <NavLink to="/login" className="ms-2 my-4 btn btn-success btn-add-cart">Ir a Checkout</NavLink>}
            </div>
