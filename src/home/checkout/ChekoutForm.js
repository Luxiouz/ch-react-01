                ...
                <form onSubmit={onSubmitForm}>
                    <div className="mb-3 d-flex align-items-center row">
                        <div className="mb-3 col-sm-6">
                            ...
                            <input name="name" type="text" className="form-control" id="exampleInputName" required value={customer.name} onChange={onCustomerChange} />
                        </div>
                        <div className="mb-3 col-sm-6">
                            <label htmlFor="exampleInputLastName" className="form-label me-2"><small>Apellido</small></label>
                            <input name="lastName" type="text" className="form-control" id="exampleInputLastName" required value={customer.lastName} onChange={onCustomerChange} />
                        </div>
                    </div>
                    <div className="mb-3 d-flex align-items-center row">
                        <div className="mb-3 col-sm-6">
                            <label htmlFor="exampleInputEmail1" className="form-label me-2"><small>Correo</small></label>
                            <input name="mail" type="email" className="form-control me-2" id="exampleInputEmail1" required value={customer.mail} onChange={onCustomerChange} />
                        </div>
                        <div className="mb-3 col-sm-6">
                            <label htmlFor="exampleInputPhone" className="form-label me-2"><small>Celular</small></label>
                            <input name="phone" type="tel" className="form-control me-2" id="exampleInputPhone" required value={customer.phone} onChange={onCustomerChange} />
                        </div>
                    </div>
                    ...
                    <div className="mb-3 d-flex align-items-center row">
                        ...
                        <div className="mb-3 col-md-6">
                            ...
                            <input name="reference" type="text" className="form-control" id="exampleInputReference" value={customer.reference} onChange={onCustomerChange} />
                        </div>
                    </div>
