        ...
        <form>
                <div className="mb-3 d-flex align-items-center row">
                    <div className="mb-3 col-sm-6">
                        <label for="exampleInputName" className="form-label me-2"><small>Nombre</small></label>
                        <input type="text" className="form-control" id="exampleInputName" required/>
                    </div>
                    <div className="mb-3 col-sm-6">
                        <label for="exampleInputLastName" className="form-label me-2"><small>Apellido</small></label>
                        <input type="text" className="form-control" id="exampleInputLastName" required/>
                    </div>
                </div>
                <div className="mb-3 d-flex align-items-center row">
                    <div className="mb-3 col-sm-6">
                        <label for="exampleInputEmail1" className="form-label me-2"><small>Correo</small></label>
                        <input type="email" className="form-control me-2" id="exampleInputEmail1" required/>
                    </div>
                    <div className="mb-3 col-sm-6">
                        <label for="exampleInputPhone" className="form-label me-2"><small>Celular</small></label>
                ...
                <div className="mb-3 d-flex align-items-center row">
                    <div className="mb-3 col-md-6">
                        <label for="exampleInputAddress" className="form-label me-2"><small>Dirección</small></label>
                        <input type="text" className="form-control" id="exampleInputAddress" required/>
                    </div>
                    <div className="mb-3 col-md-6">
                        <label for="exampleInputReference" className="form-label col-3 me-2"><small>Referencia</small></label>
                ...
                <div className="mb-3">
                    ...
                    <label className="form-check-label" for="termsCheck">Acepto todos los <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">términos y condiciones</a></label>
                </div>
